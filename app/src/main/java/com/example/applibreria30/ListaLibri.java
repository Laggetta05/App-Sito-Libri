...
public class ListaLibri extends AppCompatActivity{
    ...
    private Button home,cerca,carrello;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, "https://laggetta.altervista.org/Sito_App_Libri/api.php", null,
                (response) -> {
                    try {
